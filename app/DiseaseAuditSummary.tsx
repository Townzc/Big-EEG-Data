...
export function DiseaseAuditSummary() {
  ...
  return <section className="progress-section" aria-labelledby="disease-audit-title">
    ...
    <p className="source-note">当前 {batch.catalogEntries} 个疾病条目：{batch.standardProcessedEntries} 个有统一格式产物，{batch.downloadedCalibrationBlockedEntries} 个 UCDDB 已完成原始计数隔离、待微伏校准，{batch.notDownloadedEntries} 个未下载。本轮六项新增 {batch.standardOutputsAdded.toLocaleString('en-US')} 份标准产物；UCDDB 单列。<a href="/disease97-acquisition-status-20260913.csv" download>下载获取与处理状态</a></p>
