...
## 当前更新：2026-09-13 / 六项处理

**当前 97 个疾病条目：67 个有统一格式产物，UCDDB 1 个原始计数隔离完成但微伏校准受阻，29 个未下载。** 本轮六项已全部执行来源核验与可执行处理；新增标准格式 663 份 / 1,235.420214 h。

疾病标准分支合计 **189,919 份 / 45,314.306446 h**；库内身份合计 28,913，有证据共享关系合并后 25,469，含对照且不保证匿名库之间全球唯一。32,376 份单位仍为推断/待核。

格式为 float32 `[channel,time]` NPZ + JSON/CSV，200 Hz；单位有依据时 μV/100。UCDDB native_ADC_count 单列。Albrecht 实测 77 个文件身份（46 个患者组、31 个对照组，其中 1 个患者组身份缺人口学表行）；ADSZ AD 人物映射与 Singh2021 部分 ON/OFF 配对保留待核。EEG-0053 沿用负责人确认微伏后重新验证的 μV/100 产物。

[六项结果与全部疾病明细](PREPROCESSING_SIX_20260913.zh-CN.md) · [97 项状态](DISEASE97_STATUS_20260913.zh-CN.md) · [CSV](public/disease-preprocessing-summary-20260913.csv)

原 99 项与旧 14 项的分类对账仍为历史口径，见 [范围对应表](DISEASE_SCOPE_RECONCILIATION_20260913.zh-CN.md)。以下日期小节是历史快照；VitalDB 归意识与状态 / 麻醉，EEG-0077 归 cognitive，BEED 已排除。
